...
net_change_list = []
months = []
greatest_increase = ["", 0]  # [Month, Value]
greatest_decrease = ["", 0]  # [Month, Value]
...
with open(file_to_load) as financial_data: 
    ...
    # Extract the first row to initialize previous values
...
# Generate the output summary # Chat generated
output = (
